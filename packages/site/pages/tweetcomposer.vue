<template>
  <main class="mx-auto max-w-lg px-4 pb-12 pt-10 lg:pb-16">
    ...
    <div class="mt-4">
      <label class="block text-sm font-medium text-gray-700">Tweet Preview</label>
      <ADCard class="mt-3" shadow>
        <p class="whitespace-pre-wrap" style="word-wrap: break-word" v-text="tweet" />
        <p class="mt-5" :class="{
    ...
    <div class="mt-4">
      <label for="midlestone-summary" class="block text-sm font-medium text-gray-700">Milestone Summary</label>
      <div class="mt-1">
        <textarea v-model="summary" rows="5" name="milestone-summary"
    ...
    <div class="mt-4">
      <label for="midlestone-number" class="block text-sm font-medium text-gray-700">Milestone Number</label>
      <div class="mt-1">
        <input v-model="milestoneNumber" type="number" name="milestone-number"
          class="block w-full rounded-md border-gray-300 bg-white shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm"
          @input="onInput" />
      </div>
    </div>
