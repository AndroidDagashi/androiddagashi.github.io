...
export type Scalars = {
  ...
  Base64String: { input: unknown; output: unknown }
  BigInt: { input: unknown; output: unknown }
  CustomPropertyValue: { input: unknown; output: unknown }
  Date: { input: unknown; output: unknown }
  DateTime: { input: unknown; output: unknown }
  GitObjectID: { input: unknown; output: unknown }
  GitRefname: { input: unknown; output: unknown }
  GitSSHRemote: { input: unknown; output: unknown }
  GitTimestamp: { input: unknown; output: unknown }
  HTML: { input: unknown; output: unknown }
  PreciseDateTime: { input: unknown; output: unknown }
  URI: { input: unknown; output: unknown }
  X509Certificate: { input: unknown; output: unknown }
...
export type AddCloseIssueReferencesInput = {
  ...
  pullRequestIds: Array<Scalars['ID']['input']>
}
...
export type RemovePullRequestCreationCapBypassUsersInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>
  /** The Node ID of the repository. */
  repositoryId: Scalars['ID']['input']
...
export type ReplaceActorsForAssignableInput = {
  ...
  assignableId: Scalars['ID']['input']
  /** An array of actors to set as assignees, each with optional rationale or suggest flag. Mutually exclusive with `actorIds` and `actorLogins`. */
  assignees?: InputMaybe<Array<AssigneeUpdateInput>>
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>
}
